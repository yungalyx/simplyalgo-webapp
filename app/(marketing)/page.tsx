  ...
  return (
    <>
        ...
        <div className="grid grid-cols-3 gap-12">
          <div className="relative flex-1 overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Onboard with ease</h3>
                <p className="text-sm">
                  Save time and money by using our existing infrastructure, liquidity, and strategies.
                </p>
              </div>
            </div>
          </div>
          <div className="relative flex-1 overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Access Capital</h3>
                <p className="text-sm text-muted-foreground">
                  Amplify your returns by accessing deep liquidity across multiple exchanges. 
                </p>
              </div>
            </div>
          </div>
          <div className="relative flex-1 overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Earn Performance Fees</h3>
                <p className="text-sm text-muted-foreground">
                  Build another revenue stream by integrating the strategies you already built.
                </p>
              </div>
            </div>
          </div>
          <div className="relative flex-1 overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Subscribe to Top strategies</h3>
                <p className="text-sm text-muted-foreground">
          ...
          <div className="relative flex-1 overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Transparent Performance</h3>
                <p className="text-sm text-muted-foreground">
                  No more headaches trying to decipher cryptic performance metrics. 
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="code-block" className="pb-36">
        ...
        <div className='w-2/3'>
            <Image src={DiagramSVG} alt="diagram" width={800} className="mx-auto duration-700 ease-in-out hover:scale-105" />
          </div>
          <div className='w-1/3'>
            <h3 className="pb-2 text-xl font-semibold"> A solution for everyone. </h3>

            Launch with ease using our low- and no-code options to get started. 
            SimplyAlgo allows you to create your strategies in whichever way you feel comfortable. 
            We handle all the complications with privacy, transparency, and logging. 
            Subscribers can integrate your strategies in whatever way they feel comfortable. 
